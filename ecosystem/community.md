...
OwnPay is built with and for an international community of Web3 engineers, AI researchers, merchants, and open-source contributors.
...
- **Security Inquiries:** `security@ownpaylab.tech`

---

## Contributor Recognition

Contributors to OwnPay Lab are recognized in our [CHANGELOG.md](../CHANGELOG.md) and eligible for ecosystem grant bounties. We adhere to the [Contributor Covenant v2.1](../CODE_OF_CONDUCT.md) to maintain an inclusive, professional environment.
